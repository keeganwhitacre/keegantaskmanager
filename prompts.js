export const journalPrompts = [
  ...
  `"If someone gains, someone else loses." How much does this reflect life, and how much does it come up short?`,
  ...
  `Who was the best teacher or mentor you ever had, and why?`,
  ...
  `Why do you like/dislike the city where you live?`,
  `What's your most treasured memory from high school or college?`,
  ...
  `Which would you choose: immense wealth in obscurity or poverty and fame?`,
  ...
  `What characteristics or personality traits are most important to you in a leader?`,
  ...
  `What's the first step you can take to making a difference in the world today?`,
  ...
  `Describe each member of your family one by one.`,
  ...
  `Which holiday has the most meaning for you and why?`,
  ...
  `Why do you think some people encourage others to drink/smoke?`,
